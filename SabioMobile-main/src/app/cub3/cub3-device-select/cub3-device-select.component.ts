...
@Component({
  selector: 'cub3-device-select',
  templateUrl: './cub3-device-select.component.html',
  styleUrls: ['./cub3-device-select.component.scss']
})
export class Cub3DeviceSelectComponent {
